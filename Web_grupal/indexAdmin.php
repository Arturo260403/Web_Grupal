...
<div class="container mt-5">
    ...
    <!-- Botones para exportar y eliminar productos en Excel -->
    <?php if ($es_admin): ?>
    <div class="mb-4">
    <a href="descargar.php" class="btn btn-success">Descargar Excel</a>
<a href="eliminarProductosExcel.php" class="btn btn-danger">Eliminar Productos en Excel</a>
